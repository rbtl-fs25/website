...
4. In the File Manager in the bottom right window, locate the [`markdown-syntax.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
...
10. Let me know on the Poll that you are ready to go.

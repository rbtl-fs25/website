...
# Homework assignment {background-color="#4C326A"}
...
# Live Coding Exercise: Reproduce this plot {background-color="#4C326A"}
...
# Data Collection Tools {background-color="#4C326A"}
...
# Homework week 2 {background-color="#4C326A"}
...
# Thanks! `r emo::ji("sunflower")`  {background-color="#4C326A"}

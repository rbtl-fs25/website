...
::: learn-more
[github.com/rbtl-fs25](https://github.com/rbtl-fs25)
...
::: learn-more
[rbtl-fs25.github.io/website/modules/md-02.html](https://rbtl-fs25.github.io/website/modules/md-02.html)

```{=html}
<iframe src="https://rbtl-fs25.github.io/website/modules/md-02.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 2 documentation"></iframe>
```
:::

## Homework due date

-   Homework assignment due: [Wednesday, March 5th]{.highlight-yellow}
-   Correction & feedback phase up to: Tuesday, March 11th 

# Wrap-up {background-color="#4C326A"}

## Thanks! `r emo::ji("sunflower")` 

Slides created via revealjs and Quarto: https://quarto.org/docs/presentations/revealjs/ Access slides as [PDF on GitHub](https://github.com/rbtl-fs25/website/raw/main/slides/lec-02-visualisation.pdf)

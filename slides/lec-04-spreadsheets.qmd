...
Because it will make your and other peoples lives a little bit easier.

[
```{r, out.width="75%"}
knitr::include_graphics("img/lec-04/data-org-views.png")
```
](https://www.tandfonline.com/action/showMostReadArticles?journalCode=utas20)


::: footer
Jorunal: The American Statistician, [Screenshot taken on 2023-11-21](https://www.tandfonline.com/action/showMostReadArticles?journalCode=utas20)
:::
...
::: learn-more
[ds4owd-001.github.io/website/modules/md-03.html](https://ds4owd-001.github.io/website/modules/md-04.html)

```{=html}
<iframe src="https://ds4owd-001.github.io/website/modules/md-4.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 4 documentation"></iframe>
```
:::
...
Slides created via revealjs and Quarto: https://quarto.org/docs/presentations/revealjs/ Access slides as [PDF on GitHub](https://github.com/ds4owd-001/website/raw/main/slides/lec-03-transformation.pdf)

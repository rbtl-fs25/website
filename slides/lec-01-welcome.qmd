...
![](img/lec-01/profile-liz.png){fig-alt="Headshot of Elizabeth Tilley" fig-align="left" width=70%}
...
![](img/lec-01/profile-lars.png){fig-alt="Headshot of Lars Schöbitz" fig-align="left" width=70%}
...
4. In the left-hand menu, clock on Module 1, then select am-01: GitHub
...
::: learn-more
[rbt-fs24.github.io/website/modules/md-01.html](https://rbt-fs24.github.io/website/modules/md-01.html)

```{=html}
<iframe src="https://rbt-fs24.github.io/website/modules/md-01.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 1 documentation"></iframe>
```
:::

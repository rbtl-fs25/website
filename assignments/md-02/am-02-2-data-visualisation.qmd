...
::: {.callout-important}
## Have you completed the assignment 3 for module 1?
...
You need to enter the GitHub Personal Access Token (PAT) you created in assignment 3 of Module 1 to push your changes back to GitHub.
:::
...
7. In the "Leave a comment" field, tag the course instructor @larnsce, and ask a question.

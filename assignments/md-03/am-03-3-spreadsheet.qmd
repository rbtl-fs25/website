...
1. Layout the spreadsheet for your experiment
...
4. Make a commit and use the commit message "Create Quarto document for data import" (see also Step 6 for more detailed guidance).
...
```
Write: 1 and press Enter. This will open a new tab in your browser, where you will be asked to log in to your Google account and grant access to the `googlesheets4` package. After you have granted access, you will see a message in your Console that the authentication was successful.

...
2. Find the repository md-03-assignments-USERNAME that ends with your GitHub username, and open it.
3. Click on the green "Code" button.
4. Copy the HTTPS URL to your clipboard.
5. Open the rbtl-fs25 workspace on [https://posit.cloud/spaces/611943/content/all?sort=name_asc](https://posit.cloud/spaces/611943/content/all?sort=name_asc)
...
9. Open `md-03a-penguins-practice.qmd` & `md-03b-sanitation-visualise.qmd` and follow the instructions to work through the tasks.

## Step 2: Commit and push your changes 

The below is also described in `md-03a-penguins-practice.qmd` & `md-03b-sanitation-visualise.qmd`
...
7. In the "Leave a comment" field, tag the course instructors @larnsce and ask a question.

...
The papers we will study are available to download [here](https://drive.google.com/drive/folders/1Ngk-g-lgRiLcBGtJoksCFCh31H0k9UdO) and can also be found in the Readings section of Module 08.

Each group has been assigned a paper to read. The paper allocation list can be found here: <https://docs.google.com/spreadsheets/d/1k4qA_FOtZBGn1RL4pzfvTq-hb9-pXnH58oyY0n1nAog/edit?gid=0#gid=0>
...
2.  Your group will then share the questionnaire that you have created. Your data questionnaire will be your attempt to “reverse engineer” the data that was used to generate the results of the paper. Ask yourself: “in order to use the data that was collected, what is the best way to collect it before analysis”. 

Before class you will create a shared Google Sheet here: <https://drive.google.com/drive/folders/1c92dz9A68PLFOoXnouD5fBBmAMDAg7vF> 

The Google Sheet must have the following tabs:

-   Tab 1: The questionnaire that would have been generated for this research (i.e. the questions, the options, units etc.) 
...
-   Tab 4, 5, 6, 7: a copy of the sample spreadsheet/data frame for each of the other groups to work on during the collaborative session (more on that below)

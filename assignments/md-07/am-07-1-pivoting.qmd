...
2. Find the repository md-07-assignments-USERNAME that ends with your GitHub username, and open it.
...
9. Open `md-07a-pivoting.qmd` and follow the instructions to work through the tasks.

## Step 2: Commit and push your changes 

The below is also described in `md-07a-pivoting.qmd`.

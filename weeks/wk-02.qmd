...
Complete the homework programming assignments that are in your project folder for week 1 on [RStudio Cloud](https://rstudio.cloud/spaces/260187/content/all):
...
Complete the learning reflection that is in your project folder for week 1 on [RStudio Cloud](https://rstudio.cloud/spaces/260187/content/all) (learning-02.qmd).  

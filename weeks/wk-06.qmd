...
`r emo::ji("desktop_computer")` [Lecture 5 - Joining data & Communicating results - Download PDF](https://github.com/cven5873-ss23/website/raw/main/slides/lec-05-communicate.pdf)
...
Complete the learning reflection that is in your project folder for lecture 5 on [Posit Cloud](https://posit.cloud/spaces/381404/content/all) (learning-05.qmd).  

...
`r emo::ji("desktop_computer")` [Lecture 4 - Vectors & Tidy data - Download PDF](https://github.com/cven5873-ss23/website/raw/main/slides/lec-04-tidy-data.pdf)
...
Complete the learning reflection that is in your project folder for lecture 4 on [Posit Cloud](https://posit.cloud/spaces/381404/content/all) (learning-04.qmd).  

...
Read the syllabus and ensure that you understood the grading scheme. Note down any questions you have and submit them to the instructor using the Discussions forum for the course on GitHub. 
...
7. In the "Note" field, give your token the name: GITHUB_PAT
8. Under Expiration, select "No expiration" 
9. Under "Select scopes", select: repo, workflow, user
10. Click on "Generate token".
11. Your personal access token will be displayed on the screen. Copy it and store it in a safe place. 

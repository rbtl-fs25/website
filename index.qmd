...
```{r}
readr::read_csv("data/tab-00_rbtl-course-schedule-main.csv") |> 
...
**Homework assignments**: Each week will have at least one homework assignment. These assignments are delivered as Quarto documents with instructions and some sample code. Students are required to submit their work as a PDF through Canvas (or by email). Homework assignments are graded. The scoring will be presented on Canvas.

**Readings/Learning reflections**: Additional readings will be provided. Some are required, others are optional. Students will be asked to write 200 word reflections on the material that they have learned. These reflections are delivered as Quarto documents and graded. Students are required to submit their work as a PDF through Canvas (or by email). Scoring will be presented on Canvas. 

...
readr::read_csv("data/tbl-01-cven5837-ss23-course-schedule.csv") |> 
  dplyr::select(date, week, topic = title) |> 
...
**Homework assignments**: Each week will have at least one homework assignment. These assignments are delivered as Quarto documents with instructions and some sample code. Students are required to submit their work through GitHub. Homework assignments are graded.

**Readings/Learning reflections**: Additional readings will be provided. Some are required, others are optional. Students will be asked to write 200 word reflections on the material that they have learned. These reflections are delivered as Quarto documents and graded. Students are required to submit their work through GitHub.

**Capstone Project**: A graded capstone project provides students with an opportunity to apply their skills and techniques to real-world data sets. 

**Exam**: There is a practical 2-hour exam, which assesses the technical skills (using R tidyverse and Quarto) taught during the course. It contains programming exercises using the R programming language and you can use any material that you want. The success of the exam depends on the effort put into the homework assignments and capstone project.
...
readr::read_csv(here::here("data/tab-03_grading-scheme.csv")) |> 
  knitr::kable(caption = "Conversion from percent to grades.") |> 

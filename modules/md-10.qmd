...
1.  During class we will be using the [files in this folder (TODO)](): there are [four different]{.highlight-yellow} .csv files for you to work with:
    a.  `01_binary.csv`
    b.  `02_likert.csv`
...
[View slides in full screen](../slides/lec-10-fielding-surveys.html) | [Download slides as PDF](https://github.com/rbtl-fs24/website/raw/main/slides/lec-10-fielding-surveys.pdf)
